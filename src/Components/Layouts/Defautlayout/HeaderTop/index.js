...
export default function Header() {
    ...
    return (
        ...
        //             <li className={cx('header-list-li')}>
        //                 <i className="fa-solid fa-magnifying-glass" style={{ padding: 5 }}></i>Tra cứu đơn hàng
        //             </li>
        ...
        //                 </div>
        //             </li>
        //             <li className={cx('dropdown', 'header-list-li')}>
        //                 <span className={cx('dropdown-toggle')} data-toggle="dropdown" href="#">
        //                     VNĐ
        //                     <span className={cx('caret')} />
        //                 </span>
        //                 <ul className={cx('dropdown-menu', 'current-list')}>
        //                     <li>VNĐ|Việt Nam Đồng</li>
        //                     <li>USD |US Dollar</li>
        //                 </ul>
        //             </li>
        //             <li className={cx('dropdown', 'header-list-li')}>
        //                 <div className={cx('dropdown-toggle', 'Lang-list')} data-toggle="dropdown" href="#">
